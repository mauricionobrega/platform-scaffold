    ...
    <Provider store={store}>
        <Router>
            <Route path="/" component={App}>
                ...
                <Route component={CheckoutConfirmation} path="checkout/confirmation/" routeName="checkout-confirmation" suppressFetch Header={CheckoutHeader} Footer={CheckoutFooter} headerHasSignIn={false} />
            </Route>
        </Router>
    </Provider>
)
