...
import {Cart, CheckoutConfirmation, CheckoutPayment, CheckoutShipping, Home, LogMeIn, Login, ProductList, StartersKit, ProductDeets} from './containers/templates'
    ...
    <Provider store={store}>
        <SDKRouter>
            <Route path="/" component={App} onChange={OnChange}>
                ...
                <Route component={LogMeIn} path="customer/account/login/" routeName="signin" />
