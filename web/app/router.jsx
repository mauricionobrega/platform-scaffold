...
import {Cart, CheckoutConfirmation, CheckoutPayment, CheckoutShipping, Home, Login, ProductList, ProductDetails, PrivacyPage} from './containers/templates'
        ...
        <SDKRouter>
            <Route path="/" component={App} onChange={OnChange}>
                ...
                */}
                ...
                <Route component={PrivacyPage} path="privacy-policy-cookie-restriction-mode" routeName="privacyPage" />
            </Route>
        </SDKRouter>
    </Provider>
)
