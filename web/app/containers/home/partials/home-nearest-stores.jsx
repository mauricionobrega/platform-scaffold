            ...
            configs: [
                {
                    ...
                    nthNearest: 1, // 1st nearest store
                    maxDistance: '100', // look in 100 mi ra3dius
                    showSpinner: true,
                    template: merlinsPotionsTemplateOne // output template
                },
                {
                    selector: '#donde-closest-locations-widget-2', // render in this element
                    nthNearest: 2, // 2nd nearest store
                    maxDistance: '100', // look in 100 mi radius
                    template: merlinsPotionsTemplateTwo // output template
                },
                {
                    selector: '#donde-closest-locations-widget-3', // render in this element
                    nthNearest: 3, // 3rd nearest store
                    maxDistance: '100', // look in 100 mi radius
                    template: merlinsPotionsTemplateTwo // output template
                }
            ]
